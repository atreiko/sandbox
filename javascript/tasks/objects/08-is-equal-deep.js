...
export const isEqualDeep = (firstObj, secondObj) => {
  ...
  const secondObjectKeys = Object.keys(secondObj)

  if (firstObjKeys.length === 0 && secondObjectKeys.length === 0 ) {
    return true
  }
...
const secondObject = { a: 1, b: { c: 1 } }

const array = [ 'a', [ 'a', 5 ], 5 ]
const secondArray = [ 'a', [ 'a', 5 ], 5 ]


console.log(
  isEqualDeep(object, secondObject)
);

console.log(
  isEqualDeep(array, secondArray)
);