...
export const ProductItem = connect(mapStateToProps,
    { addFavorite, removeFavorite, openModal, openModalDelete, closeModal, addBasket, removeBasket })(
        ({ item, currentItem, price, photo, url, name, article, modaDeletelIsOpen, openModalDelete, openModal,
            inFavorite, addFavorite, removeFavorite, addBasket, inBasket, list, closeModal, modalIsOpen, removeBasket }) => {
